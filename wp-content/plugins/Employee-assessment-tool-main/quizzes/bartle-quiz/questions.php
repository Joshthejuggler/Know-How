...
$bartle_categories = [
    ...
    'si-rumination' => 'Engagement Style (R)',
    'si-avoidance' => 'Engagement Style (A)',
    'si-emotional-flood' => 'Engagement Style (F)',
];
...
$bartle_questions = [
    'teen' => [
        ...
        'si-rumination' => [
            ['text' => 'After a challenge or interaction, I often think about it long after it’s over.', 'reverse' => false],
            ['text' => 'I often explore ideas deeply because I want to understand every angle first.', 'reverse' => false],
            ['text' => 'I sometimes research or plan so much that starting becomes difficult.', 'reverse' => false],
            ['text' => 'I often revisit past choices to hunt for patterns or lessons.', 'reverse' => false],
        ],
        'si-avoidance' => [
            ['text' => 'I sometimes hesitate to start something new if I’m not sure I’ll do it well.', 'reverse' => false],
            ['text' => 'When competition or pressure rises, I might withdraw instead of pushing harder.', 'reverse' => false],
            ['text' => 'When tasks feel overwhelming, I tend to step away for a break.', 'reverse' => false],
        ],
        'si-emotional-flood' => [
            ['text' => 'In group settings, strong emotions (mine or others’) can throw me off track.', 'reverse' => false],
            ['text' => 'If something unexpected happens, my emotions can spike quickly.', 'reverse' => false],
            ['text' => 'My reactions can become intense when something important feels threatened.', 'reverse' => false],
        ],
    ],
    'graduate' => [
        'explorer' => [
